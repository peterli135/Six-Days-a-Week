...
const Orders = () => {
    ...
    // variables to control adding, updating, showing, and deleting orders. each variable comes with a setter that when called, refreshes the page
    ...
    // gets run at the initial loadup
    useEffect(() => {
        getAllOrders();
    }, [])
